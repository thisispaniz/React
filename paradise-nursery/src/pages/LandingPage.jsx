...
const LandingPage = ({ setPage }) => {
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-cover bg-center" style={{ backgroundImage: "url('C:\Users\paniz\OneDrive\Dokumente\React-1\paradise-nursery\src\assets\flowers-8013886_960_720.webp')" }}>
